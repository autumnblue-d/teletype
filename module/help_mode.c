...
const char* const help4[HELP4_LENGTH] = { "4/21 DATA AND TABLES",
                                    ...
                                    "DV.DV|DV.DV X (0-100)",
                                    "   0=RND 50=LOOP 100=SHUF",
                                    "DEJA VU LENGTH - DV.L",
                                    "DV.L|DV.L N (1-16)",
                                    "DEJA VU RELOCK LOOP - DV.R",
                                    "DEJA VU BETA OUT - DV.B",
                                    "DV.B MAX",
                                    "   BETA-SHAPED 0-MAX",
                                    "DEJA VU BETA VAR - DV.K",
                                    "DV.K A B MAX",
                                    "   VAR BETA-SHAPED 0-MAX",
                                    "BETA SHAPER - BETA",
                                    "BETA X (0-16383)",
                                    "   BELL-SHAPED 0-16383",
                                    "BETA SHAPER VAR - BETA.K",
                                    "BETA.K A B X",
                                    "   8=FLAT >8 BELL <8 EDGE"
                                    };
...
const char* const help14[HELP14_LENGTH] = { "15/21 ANSIBLE",
                                      ...
                                      "    TRACK X, PARAM Y TO Z",
                                      "KR.TMUL X Y / X Y Z",
                                      "    GET/SET CLOCK DIVIDER",
                                      "    TRACK X, PARAM Y (1-16)",
                                      "KR.RES X Y",
                                      "    RESET TRACK X TO LOOP",
                                      "    START (0=ALL); Y UNUSED",
                                      "KR.CV X",
                                      ...
                                      "    ENABLE STATE (0/1)",
                                      "KR.MP X Y / KR.MP X Y Z",
                                      "    GET/SET MP-SEQ LANE X",
                                      "    FIELD Y: 0CNT 1SPD 2MIN",
                                      "    3MAX 4RULE 5DEST 6TRIG",
                                      "    7TOG 8RST 9TGT 10SMIN",
                                      "    11SMAX",
                                      "KR.MP.POS X / X Y",
                                      "    GET/SET LANE X POSITION",
                                      "KR.MP.MUTE X / X Y",
                                      "    GET/SET LANE X FIRE MUTE",
                                      "KR.MP.SCR / KR.MP.SCR X",
                                      "    GET/SET LANE0 SCRIPT",
                                      "    (1-8; LANE I = X+I)",
                                      "ME.PRE / ME.PRE X",
                                      "    RETURN/LOAD CURRENT PRESET",
                                      "ME.SCALE / ME.SCALE X",
...
const char* const help18[HELP18_LENGTH] = { "19/21 MEADOWPHYSICS",
                                      ...
                                      "8T: 8 GATES,",
                                      "  TR1-4, CV1-4=10V",
                                      "SCR: ROW N=SCRIPT N+1",
                                      " ",
                                      "OPS:",
                                      "MP.RUN x    1=RUN 0=STOP",
                                      "MP.RESET x  0=ALL",
                                      "MP.STOP x   1-8=ROW",
                                      "MP.PRESET x  LOAD SLOT 0-7",
                                      "MP.SYNC x   0I 1TR 2M",
                                      "MP.CLK      STEP ONCE",
                                      "MP.VOICE x  0-4",
                                      "MP.PERIOD x  MS",
                                      "MP.SCALE x  SLOT 0-15",
                                      "MP.SCL s d x  RUNG 0-7",
                                      "MP.CFG r f x  CASCADE",
                                      "  f:0CNT 1SPD 2MIN 3MAX",
                                      "  4RULE 5DST 6TRG 7TOG",
                                      "  8RST 9TGT 10SMIN 11SMX",
                                      "MP.CV row  GET ROW CV 1-8",
                                      " ",
                                      "PLAYS IN OTHER",
                                      "MODES; OWNS CV/TR.",
                                      "8 PRESET SLOTS,",
...
const char* const help21[HELP21_LENGTH] = { "21/21 EARTHSEA",
                                      ...
                                      " ",
                                      "OPS:",
                                      "ES.RUN x|PLAY/STOP; GET RUN",
                                      "ES.PATTERN|SEL/GET 0-15",
...
const uint8_t help_length[HELP_PAGES] = {
    ...
    HELP19_LENGTH, HELP11_LENGTH, HELP12_LENGTH, HELP13_LENGTH, HELP14_LENGTH,
