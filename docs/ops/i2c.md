...
No validation or transformation is applied to any of the parameters - they are sent as is. As dedicated ops are often 1-based, you might want to subtract 1 when reproducing them with the generic ops.
