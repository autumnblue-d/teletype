...
- **NEW**: Marbles-style déjà vu random ops: `DV`, `DV.DV`, `DV.L`, `DV.R`
...
Support for controlling Whimsical Raps W/ module via i2c. See the respective section for a complete list of available ops and refer to [the W/ page](https://www.whimsicalraps.com/pages/w-type) for more details.
